...
def obstacle_movement(obstacle_list):
    if obstacle_list:
        ...
        obstacle_list = [obstacle for obstacle in obstacle_list if obstacle.x > -100] # deletes the rectangles that are useless
...
player_rect = player_surf.get_rect(midbottom = (80, 300)) # x, y
player_gravity = 0
...
while True:
    ...
    if game_active:
        screen.blit(sky_surf, (0,0)) # surface, position  # block image transfer # Origin point is in top left
